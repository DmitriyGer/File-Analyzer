...
public class CorrectingMetadataController {
    ...
    /**
     * 1. Добавить возможность исправления метаданных в таблице после предварительного сканирования btnStartSearch
     ...
     * 
     * 5. Сдкелать кнопку "Исправить" неактивной, пока не произведется сканирвоание 
     */
    @FXML
    void initialize() {
