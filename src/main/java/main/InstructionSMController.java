...
public class InstructionSMController {
    ...
    private static void initializeTextFlow(TextFlow textFlow) {
        String[] texts = {
                ...
                "\n\n3. Вывод отсортированных данных. Программа поддерживаем три режима работы с данными пользователя:",
                "\n\tа. Отсортировать в текущей папке. В текущем режиме программа упорядочивает содержимое текущей\n \t    папки, создавая необходимые подпапки и перемещая в них отсортированные\n \t    медиафайлы.",
