...
public class DiskAnalyzerChoiceController {
    ...
    private static void initializeTextFlow(TextFlow textFlow) {
        String[] texts = {
                ...
                "Иерархический. Функция анализатора дискового пространства, предоставляет возможность пользователям видеть иерархию ",
                ...
                "обеспечивая наглядное представление и оптимизирует использование ресурсов хранения."
        };
