...
public class InstructionDAController {
    ...
    private static void initializeTextFlow(TextFlow textFlow) {
        String[] texts = {
                ...
                "\n\tг. Открыть в новом окне. Для удобства работы вывода данных было создано окно, позволяющее\n \t    открывать программу на весь экран, что позволяет эффективнее рабоать с программой.",
                ...
                "\n\tа. При запуске анализатора возможно кратковременное зависание программы. Не беспокойтесь,\n \t    программа не зависла, происходит инициализация файлов.",
                "\n\tб. После завершения сканирования для каждой папки и файла появляется зелёная шкала. Она\n \t    графически показывает, сколько места занимает элемент в папке или на диске.",
                "\n\tв. В правой части таблицы вы найдёте информацию о дате создания файла или папки, их размере в\n \t    процентном соотношении занимаемого ими места на диске."
        };
